...
Use the [`get`](/{{{polymer_version_dir}}}/api/polymer-element#PolymerElement-method-get) method to retrieve a value based on
its path.
...
Use the [`set`](/{{{polymer_version_dir}}}/api/polymer-element#PolymerElement-method-set) method to
...
<a href="/{{{polymer_version_dir}}}/api/polymer-element#PolymerElement-method-notifySplices">`notifySplices`</a>
...
Use [`setProperties`](/{{{polymer_version_dir}}}/api/polymer-element#PolymerElement-method-setProperties)
...
Use the [`linkPaths`](/{{{polymer_version_dir}}}/api/polymer-element#PolymerElement-method-linkPaths)
