...
Call [`render`](/{{{polymer_version_dir}}}/api/elements/dom-repeat#DomRepeat-method-render)
...
*   If you don't have an exact set of changes, you can set the
    [`mutableData`](/{{{polymer_version_dir}}}/api/elements/dom-repeat#DomRepeat-property-mutableData)
...
[`initialCount`](/{{{polymer_version_dir}}}/api/elements/dom-repeat#DomRepeat-property-initialCount).
In chunked mode,
...
[`renderedItemCount`](/{{{polymer_version_dir}}}/api/elements/dom-repeat#DomRepeat-property-renderedItemCount)
read-only property.
...
[`targetFramerate`](/{{{polymer_version_dir}}}/api/elements/dom-repeat#DomRepeat-property-targetFramerate).

You can also set a debounce time that must pass before a `filter` or `sort`
function is re-run by setting the
[`delay`](/{{{polymer_version_dir}}}/api/elements/dom-repeat#DomRepeat-property-delay)
property.
