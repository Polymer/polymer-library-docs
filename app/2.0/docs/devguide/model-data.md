...
Use the [`get`](/{{{polymer_version_dir}}}/api/elements/Polymer.Element#method-get) method to retrieve a value based on
its path.
...
Use the [`set`](/{{{polymer_version_dir}}}/api/elements/Polymer.Element#method-set) method to
...
<a href="/{{{polymer_version_dir}}}/api/elements/Polymer.Element#method-notifySplices">`notifySplices`</a>
...
Use [`setProperties`](/{{{polymer_version_dir}}}/api/mixins/Polymer.PropertyEffects#method-setProperties)
...
Use the [`linkPaths`](/{{{polymer_version_dir}}}/api/elements/Polymer.Element#method-linkPaths)
